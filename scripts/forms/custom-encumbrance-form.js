...
export class CustomEncumbranceForm extends FormApplication {
    constructor (...args) {
        super(args)
    }
    ...
    static get defaultOptions () {
        return mergeObject(super.defaultOptions, {
            ...
            dragDrop: [{
                dragSelector: '.custom-encumbrance-drag',
    ...
    async _deleteItem (key) {
        ...
        const d = new Dialog({
            title: game.i18n.localize('CUSTOM_ENCUMBRANCE_SETTINGS.dialog.delete.title'),
            content: `<p>${game.i18n.localize('CUSTOM_ENCUMBRANCE_SETTINGS.dialog.delete.content')}</p>`,
            buttons: {
                yes: {
                    icon: '<i class="fas fa-check"></i>',
                    label: game.i18n.localize('CUSTOM_ENCUMBRANCE_SETTINGS.dialog.delete.yes'),
                    callback: async () => {
                        del(key)
                    }
                },
                no: {
                    ...
                    label: game.i18n.localize('CUSTOM_ENCUMBRANCE_SETTINGS.dialog.delete.no')
                }
            }
        })
        d.render(true)
